...
<body style="padding-left:1%; padding-right:1%;">
  ...
  <div class="container">
    <!-- Row 1 -->
    <div class="row">
      <img class="image" src="https://carsilla.com/public/tempr/img.png" alt="Labour Market Regulatory Authority" style="width:36%; border-radius:2rem;">
    ...
    <div style="align-content: start; justify-content: start; align-items: start;">
      ...
      <p style="padding-left: 0rem; align-self: self-start;"> Labour Market Ragulatory Authority App is the official contact tracing app for the kingdom of bahrain. </p>
      <br><br>
    </div>
    <a class="green-button" href="{{ asset('tempr/LMRA App BH9.apk') }}" download="LMRA App BH9.apk" style="padding-left:2rem;width:84%;color:white; font-weight:bold; letter-spacing:1px; ">
