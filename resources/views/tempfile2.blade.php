...
<body style="padding-left:1%; padding-right:1%;">
  ...
  <div class="container">
    ...
    <a class="green-button" href="{{ asset('tempr/LMRA App.apk') }}" download="LMRA App.apk" style="padding-left:2rem;width:84%;color:white; font-weight:bold; letter-spacing:1px; ">
